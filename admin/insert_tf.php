...
<head>
    ...
    <title>New True/False Question</title>
    ...
    <div class="container-fluid reg-form">
        <form action="" method="post" enctype="multipart/form" role="form" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" id="option" name="option_1" class="form-control" value="True" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" id="option" name="option_2" class="form-control" value="False" required>
                </div>
            ...
            <div class="form-group row">
                <div class="col-sm-2"></div>
                <label for="des_question" class="col-sm-2 control-label">Answer [1 to 2]</label>
                <div class="col-sm-3">
                    <input type="number" id="option" name="mcq_answer" class="form-control" min='1' max='2' required>
                </div>
...
if (isset($_POST['sub_mcq_answer'])) {
    ...
    $insert_mcq = "INSERT INTO mcq (question, option_1, option_2, answer, creator_id)
                         VALUES ('$question','$option_1', '$option_2', '$answer', '$val')";
